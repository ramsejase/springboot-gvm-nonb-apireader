...
public class Swe {
    ...
    public Swe withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Swe withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Swe withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Swe.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
