...
public class Est {
    ...
    public Est withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Est withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Est withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Est.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
