...
public class Ita {
    ...
    public Ita withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Ita withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Ita withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ita.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
