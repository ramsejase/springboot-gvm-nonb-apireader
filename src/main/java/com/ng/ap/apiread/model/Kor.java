...
public class Kor {
    ...
    public Kor withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Kor withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Kor withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Kor.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
