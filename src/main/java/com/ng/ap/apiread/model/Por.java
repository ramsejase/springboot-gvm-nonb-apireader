...
public class Por {
    ...
    public Por withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Por withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Por withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Por.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
