...
public class Fra {
    ...
    public Fra withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Fra withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Fra withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Fra.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
