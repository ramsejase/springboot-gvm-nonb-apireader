...
public class Jpn {
    ...
    public Jpn withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Jpn withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Jpn withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Jpn.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
