...
public class Slk {
    ...
    public Slk withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Slk withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Slk withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Slk.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
