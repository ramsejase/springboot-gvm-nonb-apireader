...
public class Hun {
    ...
    public Hun withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Hun withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Hun withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Hun.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
