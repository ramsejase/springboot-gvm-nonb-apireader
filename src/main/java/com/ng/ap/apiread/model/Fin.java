...
public class Fin {
    ...
    public Fin withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Fin withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Fin withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Fin.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
