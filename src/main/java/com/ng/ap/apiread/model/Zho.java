...
public class Zho {
    ...
    public Zho withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Zho withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Zho withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Zho.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
