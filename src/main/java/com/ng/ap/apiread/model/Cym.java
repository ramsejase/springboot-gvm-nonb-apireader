...
public class Cym {
    ...
    public Cym withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Cym withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Cym withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Cym.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
