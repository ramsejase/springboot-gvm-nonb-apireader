...
public class Ces {
    ...
    public Ces withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Ces withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Ces withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Ces.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
