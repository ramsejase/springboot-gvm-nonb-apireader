...
public class Nld {
    ...
    public Nld withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Nld withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Nld withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Nld.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
