...
public class Deu {
    ...
    public Deu withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Deu withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Deu withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Deu.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
