...
public class Hrv {
    ...
    public Hrv withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Hrv withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Hrv withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Hrv.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
