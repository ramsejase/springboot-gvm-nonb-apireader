...
public class Pol {
    ...
    public Pol withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Pol withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Pol withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Pol.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
