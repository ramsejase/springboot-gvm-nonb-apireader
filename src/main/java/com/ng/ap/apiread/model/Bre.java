...
public class Bre {
    ...
    public Bre withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Bre withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Bre withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Bre.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
