...
public class Rus {
    ...
    public Rus withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Rus withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Rus withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Rus.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
