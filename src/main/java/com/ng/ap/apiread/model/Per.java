...
public class Per {
    ...
    public Per withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Per withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Per withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Per.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
