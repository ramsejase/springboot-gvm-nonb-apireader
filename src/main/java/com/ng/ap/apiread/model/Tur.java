...
public class Tur {
    ...
    public Tur withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Tur withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Tur withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Tur.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
