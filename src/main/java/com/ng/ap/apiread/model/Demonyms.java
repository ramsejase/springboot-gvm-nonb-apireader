...
public class Demonyms {
    ...
    public Demonyms withEng(Eng__1 eng) {
        this.eng = eng;
        return this;
    }
    ...
    public Demonyms withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Demonyms.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("eng");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Demonyms) == false) {
            return false;
        }
        Demonyms rhs = ((Demonyms) other);
