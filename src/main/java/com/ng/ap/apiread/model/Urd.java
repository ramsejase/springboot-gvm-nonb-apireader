...
public class Urd {
    ...
    public Urd withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Urd withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Urd withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Urd.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("official");
        sb.append('=');
