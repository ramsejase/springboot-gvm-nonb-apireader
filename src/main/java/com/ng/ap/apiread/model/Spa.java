...
public class Spa {
    ...
    public Spa withOfficial(String official) {
        this.official = official;
        return this;
    }
    ...
    public Spa withCommon(String common) {
        this.common = common;
        return this;
    }
    ...
    public Spa withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
